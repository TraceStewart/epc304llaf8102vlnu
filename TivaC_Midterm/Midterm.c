...
void main (void)
{
    char HTTP_POST[256];    //string buffer to hold the HTTP command
	...
	//usprintf (HTTP_POST, "GET /update?key=W86U4X7NUJNKEMGG&field1=\n\r", lux);
	SysCtlDelay (10000000);
	UARTprintf("AT+CIPSEND=%i\r\n", 46);//strlen(HTTP_POST));	//command the ESP8266 to allow sending of information
	SysCtlDelay (10000000);
	UARTprintf("GET /update?key=W86U4X7NUJNKEMGG&field1=%i\n\r", lux); //send the string of the HTTP GET to the ESP8266
